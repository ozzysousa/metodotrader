      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="group relative glass-card rounded-2xl p-6 border border-border/30 hover:border-primary/40 transition-all duration-500 hover:shadow-[0_0_40px_hsl(168_100%_42%/0.15)] hover:-translate-y-1"
